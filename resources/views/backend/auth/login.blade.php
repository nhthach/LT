  ...
  <div class="login-box-body">
   ...
   {!! Form::open([
      ...
      <div class="form-group has-feedback">
         {!!
          Form::email('login[name]','',['required','placeholder'=>'Email','id' => 'name ', 'class'=>'form-control'])        
        !!}
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
         {!!
          Form::password('login[password]',['required','placeholder'=>'Password','id' => 'password ', 'class'=>'form-control'])      
        !!}
